          ...
          <div className="space-y-6 text-love-600">
            ...
            <div className="space-y-4 leading-relaxed">
              <p className="text-lg">
                ...
                ถึงเค้าจะขี้น้อยใจ ขี้งอน มึนมากก แต่เค้าก็ชอบนะเวลาที่มีเธออ่ะ คือโครตดีใจอ่ะ
              </p>
              <p className="text-lg">
                เค้าอยากมีเธอไปตลอดเลยนะ ถึงจะทะเลาะกันบ้าง งอนกันบ้าง น้อยใจกันบ้าง
                แต่เค้าขอเธออย่างเดียวเลย หันหน้าคุยกับเขาได้ไหม เค้าไม่อยากให้ใครมาปลอบเธอแล้วนอกจากเค้า
              </p>
              <div className="pt-4 text-right">
                <p className="text-lg">เค้ารักเธอนะอ้วนน</p>
              </div>
            </div>
          </div>
        </div>
